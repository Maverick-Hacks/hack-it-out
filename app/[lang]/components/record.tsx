    ...
    <div className="relative flex w-full flex-col overflow-x-hidden bg-[#FCFCFC] px-4 py-2 pt-2 md:px-8">
      {completed ? (
        <Results
          ...
          privacySave={props.data.privacySave}
          transcript_heading={props.data.transcript}
          transcript={transcript}
          feedback_title={props.data.feedback}
          feedback={generatedFeedback}
          chat_title={props.data.chat_title}
          chat_placeholder={props.data.chat_placeholder}
        />
      ) : (
          ...
          {recordingPermission ? (
            <div className="mx-auto flex w-full max-w-[720px] flex-col justify-center">
              ...
              <div className="w-full">
                <div className="relative aspect-[9/12] w-full overflow-hidden rounded-lg bg-[#1D2B3A] shadow-md ring-1 ring-gray-900/5 max-sm:max-h-[400px] sm:aspect-[16/9] sm:max-w-[720px]">
                  {!cameraLoaded && (
                            ...
                            <div className="flex flex-row gap-2">
                              {!isSubmitting && (
                                <button
                                  ...
                                  className="group flex scale-100 items-center justify-center gap-x-2 rounded-full bg-white px-4 py-2 text-[13px] font-semibold text-[#1E2B3A] no-underline opacity-80 transition-all  duration-75 hover:opacity-100 active:scale-95"
                                >
                              ...
                              <button
                                ...
                                className="group flex min-w-[140px] scale-100 items-center justify-center rounded-full bg-[#1E2B3A] px-4 py-2 text-[13px] font-semibold text-white no-underline opacity-90 transition-all  duration-75 hover:opacity-100 active:scale-95  disabled:cursor-not-allowed"
                                style={{
                                  boxShadow:
            ...
            <div className="mx-auto flex w-full max-w-[720px] flex-col justify-center">
              <div className="relative flex aspect-[9/12] w-full max-w-[720px] flex-col items-center justify-center overflow-hidden rounded-lg bg-[#1D2B3A] shadow-md ring-1 ring-gray-900/5 max-sm:max-h-[400px] md:aspect-[16/9]">
